...
<button class="sfx" class:muted={isMuted} on:pointerdown={toggle}>
...
<style>
  ...
  .sfx > svg:nth-child(1), .sfx.muted > svg:nth-child(2) {
    display: none;
  }

  .sfx.muted > svg:nth-child(1) {
    display: block;
  }

  :global(body.inputlock) .sfx {
    display: none;
  }
</style>
